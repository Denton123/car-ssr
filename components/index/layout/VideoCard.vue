  ...
  <div class="video_card_list">
    <dl class="video_card"
      ...
      <dd class="video_display">
        <router-link :to="`/video/detail/${item.id}`">
          <img :src="item.photo"
            :alt="item.title" />
        </router-link>
...
.video_card .video_title:hover .video_title_line {
  background: url("~assets/picture/line_red.png") no-repeat;
}
.video_card .video_title:hover {
  color: #be001e;
}
.video_title_line {
  background: url("~assets/picture/line_gray.png") no-repeat;
  width: 3px;
  height: 21px;
